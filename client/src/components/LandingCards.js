					...
					<Card className={classes.card} style={{ background: '#4267b2' }}>
						<CardContent>
							...
							<Typography
								...
								basic frontend layout. Other relevant libraries used are Redux
								Form, bcrypt for hashing passwords and cookie-session to store
								sessions.
							</Typography>
						</CardContent>
					</Card>
				...
				<Grid container item spacing={8} alignItems="stretch">
					<Grid item md={6} xs={12}>
						<Card
							...
							style={{ background: '#ff6f60', height: '100%' }}>
							<CardContent>
								<Typography
									variant="headline"
									component="h2"
					...
					<Grid item md={6} xs={12}>
						<Card className={classes.card}>
							<CardContent>
								...
								<Typography component="p" style={{ marginBottom: '10px' }}>
									You can also create a new account with your email and
									password. In this case an email confirmation will be sent.
								</Typography>
								<Typography component="p" style={{ marginBottom: '10px' }}>
